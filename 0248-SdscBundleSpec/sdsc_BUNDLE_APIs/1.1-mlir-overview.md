...
Follow the link for a description of the [SuperDSC-Bundle Interface Specification](https://github.ibm.com/jneves/sdsc-bundle-spec/blob/sdsc-bundle-spec/RFCs/0248-SdscBundleSpec/SuperDSC-Bundle.md).
