...
| `hbm.dsOffset` | integer | No | — | Byte offset of this tensor within its HBM allocation. Set alongside `allocateNode_`. |
...
| `lx.dsOffset` | integer | No | — | Byte offset of this tensor within its LX allocation. Set alongside `allocateNode_`. |
